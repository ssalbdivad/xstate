...
) => T extends ActorLogic<infer TActorEvent, infer TActorEmitted>
...
> = TActors extends { src: infer TSrc }
  ...
  : {
       ...
       * The source of the machine to be invoked, or the machine itself.
       */
      src: ActorLogic<any, any>; // TODO: fix types
...
export type EventFromLogic<TLogic extends ActorLogic<any, any>> =
  TLogic extends ActorLogic<infer TEvent, infer _> ? TEvent : never;
